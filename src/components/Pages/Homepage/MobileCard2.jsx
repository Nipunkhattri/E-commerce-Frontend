...
const MobileCard2 = () => {
  ...
  const handleBack = () => {
    setActiveStep(
      (prevStep) => (prevStep - 1 + backgrounds.length) % backgrounds.length
    );
  };
  ...
  return (
    <div style={{ display: isMobile ? "block" : "none", overflow: "hidden" }}>
              ...
              <div className="card2div1">
                <div className="insidecard2">
                  <div className="insidecard2inside">
                    ...
                    <h3>MOONSTONE</h3>
                    <p>
                      Buna embodies a slow way of life that is rooted in
                      culture, craft and of breath-ability, light and airiness
                      that it wants its wearers to be part of. of
                      breath-ability,
                    </p>
        ...
        <div className="card2div2up">
          <div>
            ...
            <p>
              ...
              wearers to be part of. of breath-ability,
            </p>
          </div>
        </div>
